...
public: \
	DECLARE_CLASS(UFlamethrower, UActorComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/WeaponSystem"), NO_API) \
...
#define WeaponSystem_Source_WeaponSystem_Public_Weapon_Flamethrower_h_18_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UFlamethrower); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UFlamethrower); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UFlamethrower(UFlamethrower&&); \
	NO_API UFlamethrower(const UFlamethrower&); \
public:
...
template<> WEAPONSYSTEM_API UClass* StaticClass<class UFlamethrower>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID WeaponSystem_Source_WeaponSystem_Public_Weapon_Flamethrower_h
